...
alert(hello+" " +world);
window.location.href = "http://localhost/Anu/web/NewServices.php?w1=" + hello + "&w2=" + world;
		}
		</script>
		...
		<div class="clear"></div>
				...
				<!--		<div class="pricing-grid">
						...
						<div class="pricing-grid1">							
							...
							<!-- <div class="cart1">
								<div class="span3"><a onclick="function1();" href="http://localhost/Anu/web/about.php"><j>View Available Players</j></a>
							</div>	
							</div>
						</div>-->
						...
						<div class="clear"> </div> 
							...
							<h3><a href="#">Sentiment Mining</a></h3>
							<ul>
							<li><a href="#"></a></li>
								<li><a href="#"></a></li>
								<li><a href="#"></a></li>
